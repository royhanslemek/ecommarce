...
<section class="contact">
   ...
   <form action="" method="post">
      ...
      <input type="number" name="number" min="0" max="9999999999" placeholder="Masukkan nomor telepon Anda" required onkeypress="if(this.value.length == 10) return false;" class="box">
