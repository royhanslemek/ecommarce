   ...
   <section class="checkout-orders">
      <form action="" method="POST">
            ...
            <div class="flex">
               ...
               <div class="inputBox">
                  <span>Kota:</span>
                  <input type="text" name="city" placeholder="Jakarta" class="box" maxlength="50" required>
               </div>
               <div class="inputBox">
                  <span>Provinsi:</span>
                  <input type="text" name="state" placeholder="DKI Jakarta" class="box" maxlength="50" required>
               </div>
               <div class="inputBox">
                     <span>Negara:</span>
