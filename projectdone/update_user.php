...
if(isset($_POST['submit'])){
   ...
   if($old_pass == $empty_pass){
      $message[] = 'harap masukkan kata sandi lama!';
      ...
      if($new_pass != $empty_pass){
         ...
         $message[] = 'harap masukkan kata sandi baru!';
      }
   }
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" required placeholder="masukkan nama pengguna Anda" maxlength="20"  class="box" value="<?= $fetch_profile["name"]; ?>">
      ...
      <input type="password" name="cpass" placeholder="konfirmasi kata sandi baru" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
