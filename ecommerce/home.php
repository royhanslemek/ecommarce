...
<section class="home">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <div class="content">
            <span>diskon 50% off</span>
            <h3>Royhan Fashion</h3>
      ...
      <div class="swiper-slide slide">
         <div class="image">
            <img src="images/home-img-5-removebg-preview.png" alt="">
         </div>
         <div class="content">
         <span>diskon hingga 50%</span>
            <h3>HP berkualitas</h3>
            <a href="shop.php" class="btn">Beli Sekarang</a>
         </div>
      </div>
...
<section class="category">
   ...
   <a href="category.php?category=baju"  class="swiper-slide slide">
      <img src="images/icon-9.jpg" alt="">
      <h3>baju</h3>
   </a>

   <a href="category.php?category=celana"  class="swiper-slide slide">
      <img src="images/icon-10.jpg" alt="">
      <h3>celana</h3>
   </a>

   <a href="category.php?category=hoodie"  class="swiper-slide slide">
      <img src="images/icon-11.jpg" alt="">
      <h3>hoodie</h3>
   </a>

   <a href="category.php?category=hanphone" class="swiper-slide slide">
